...
public partial class MakeFolderTabView : UserControl
{
    ...
    {
        if (_suffixIsUntouchedDefault && SuffixTextBox.Text == MakeFolderViewModel.DefaultSuffix)
        {
    ...
    {
        if (SuffixTextBox.Text != MakeFolderViewModel.DefaultSuffix)
        {
